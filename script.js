                  ...
                  "",  "الفاتحة", "البقرة", "آل عمران", "النساء", "المائدة",
                    ...
                    // استخدام Fetch API لجلب البيانات
                     ...
                     if (z % 2 == 0) {
                      ...
                      document.getElementById("secondImg").src="img/hejejdjdbc.png"
                    ...
                    document.getElementById("hr0").style.width="0px" 
                     // تغيير لون جميع الفقرات
                     paragraphs.forEach(p => {
                     p.style.color = "#085484"; // أو أي لون تريده
                     });
                     } else {
                      document.getElementById("secondImg").src="img/6886574.png"
...
body.append(fin)
function protocol(){ 
    select = document.getElementById("firstButton")

//first
if(select.value=="Rewayat-Hafs-A-n-Assem"){


          for(m=1;m<115;m++){
 
           audioElement =  document.getElementById(`${m}`)
          if(m==0){
           ...
           audioElement.load()
                 ...
                 //second 
                 if(select.value=="Rewayat-Aldori-A-n-Abi-Amr"){
                 ...
                 audioElement =  document.getElementById(`${m}`)
                 if(m==0){
                 apiUrl = `https://server16.mp3quran.net/deban/Rewayat-Aldori-A-n-Abi-Amr/001.mp3`;
                 document.getElementById(`np${m}`).src=apiUrl
                 console.log(apiUrl)
                 }    
                 if(m>=0 & m<10){
                 
                 apiUrl = `https://server16.mp3quran.net/deban/Rewayat-Aldori-A-n-Abi-Amr/00${m}.mp3`;
                 document.getElementById(`np${m}`).src=apiUrl
                 console.log( document.getElementById(`np${m}`).src)
                 audioElement.load()
                 }
                 if(m>=10 & m<100){
                 apiUrl = `https://server16.mp3quran.net/deban/Rewayat-Aldori-A-n-Abi-Amr/0${m}.mp3`;
                 document.getElementById(`np${m}`).src=apiUrl
                 console.log(apiUrl)
                 audioElement.load()
                 }
                 if(m>=100 & m<120){
                 apiUrl = `https://server16.mp3quran.net/deban/Rewayat-Aldori-A-n-Abi-Amr/${m}.mp3`;
                 document.getElementById(`np${m}`).src=apiUrl
                 console.log(apiUrl)
                 audioElement.load()
                 ...
                 if(select.value=="Rewayat-Albizi-A-n-Ibn-Katheer"){
                 ...
                 audioElement =  document.getElementById(`${m}`)
                 if(m==0){
                 apiUrl = `https://server16.mp3quran.net/deban/Rewayat-Albizi-A-n-Ibn-Katheer/001.mp3`;
                 document.getElementById(`np${m}`).src=apiUrl
                 console.log(apiUrl)
                 }    
                 if(m>=0 & m<10){
                 
                 apiUrl = `https://server16.mp3quran.net/deban/Rewayat-Albizi-A-n-Ibn-Katheer/00${m}.mp3`;
                 document.getElementById(`np${m}`).src=apiUrl
                 console.log( document.getElementById(`np${m}`).src)
                 audioElement.load()
                 }
                 if(m>=10 & m<100){
                 apiUrl = `https://server16.mp3quran.net/deban/Rewayat-Albizi-A-n-Ibn-Katheer/0${m}.mp3`;
                 document.getElementById(`np${m}`).src=apiUrl
                 console.log(apiUrl)
                 audioElement.load()
                 }
                 if(m>=100 & m<120){
                 apiUrl = `https://server16.mp3quran.net/deban/Rewayat-Albizi-A-n-Ibn-Katheer/${m}.mp3`;
                 document.getElementById(`np${m}`).src=apiUrl
                 console.log(apiUrl)
                 audioElement.load()
